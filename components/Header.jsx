  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      <div>
        ...
        <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! William Mark  <Image src={assets.hand_icon} alt='' className='rounded-full w-6' /></h3>
        <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>frontend web developer based in London</h1>
        <p className='max-w-2xl mx-auto font-Ovo'>I am frontend developer from California, USA with 10 uears of experience in multiple companies like Microsoft, Tesla and Apple</p>
