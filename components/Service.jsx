...
const Service = ({isDarkMode}) => {
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto  mt--5  mb-12  font-Ovo'>Building dynamic, high-performance web applications using React.js, ensuring smooth user experiences with optimized UI components.</motion.p>
